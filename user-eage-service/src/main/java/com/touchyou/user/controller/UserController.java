package com.touchyou.user.controller;

import com.touchyou.thrift.user.UserInfo;
import com.touchyou.thrift.user.dto.UserDTO;
import com.touchyou.user.redis.RedisClient;
import com.touchyou.user.response.LoginResponse;
import com.touchyou.user.response.Response;
import com.touchyou.user.thrift.ServiceProvider;
